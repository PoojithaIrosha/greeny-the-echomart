...
if (empty($email)) {
    ...
    if ($rs->num_rows == 1) {
        ...
        Database::iud("UPDATE `admin` SET `verification_code` = '" . $uid . "' WHERE `email` = '" . $email . "'");
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('example@gmail.com', 'Greeny');
            $mail->addAddress($email);               //Name is optional
            $mail->addReplyTo('example@gmail.com', 'Greeny');
            ...
            <div
                ...
                <center>
                    ...
                    <p>If you forgot your password or wish to <span class="il">reset</span> it,<br>use below link to change
                        your password </p><br>
                    <a href="http://localhost/greeny/admin/change-password.php?uid=' . $uid . '"
